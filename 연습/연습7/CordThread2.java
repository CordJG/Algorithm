...
class Aari{
    ...
    CordThread2 cord = new CordThread2("매혹");
    public void run() { // start() 메소드 사용 시
        System.out.println("시전한 스킬 : " + cord.skill_name);

        for(int i = 1; i<=3; i++) {
            System.out.println(cord.skill_name + " 스킬을 " + i + "초간 시전 중입니다..");
        }

        System.out.println("시전 끝난 스킬 : " + cord.skill_name);
    }
}
